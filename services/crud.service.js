import {DbConfig} from "../configuration/db.config.js";
...
const appDataSource = await new DbConfig().dataSource.initialize();
...
export class DogService {
    ...
    async updateDog(dog, did) {
        return this.#dogRepo.update({did: did}, dog).then((dog) => {   // work too ({where id updates} , <value as object>)
